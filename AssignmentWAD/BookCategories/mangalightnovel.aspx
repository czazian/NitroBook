    ...
    <div class="row">
        <div class="col-2">
            ...
            <div id="list-example" class="list-group">
                ...
                <asp:LinkButton ID="LinkButton2" runat="server" Text="Slice-of-Life" PostBackUrl="#list-item-3" CssClass="lkbSubCat"></asp:LinkButton>
        ...
        <div class="col-10">
            ...
            <!-- Sub Category Name -->
            <h1 style="padding-left: 15px; font-size: 50px;"><strong>Reincarnation</strong></h1>
          ...
          <i data-bs-toggle="tooltip" data-bs-title="Add to Cart" class="fa fa-shopping-cart"></i>
                        ...
                        <asp:LinkButton ID="LinkButton3" runat="server" PostBackUrl="~/Order/checkout.aspx" CssClass="mrg btn btn-2 btn-sep icon-cart" OnClick="btnBuyNow_Click">
          <i data-bs-toggle="tooltip" data-bs-title="Buy Now" class="fa fa-shopping-bag"></i>
                        </asp:LinkButton>
                        <asp:LinkButton ID="LinkButton4" runat="server" PostBackUrl="~/Product/IndividualProduct.aspx" CssClass="mrg btn btn-2 btn-sep icon-cart" OnClick="btnViewMore_Click">
          <i data-bs-toggle="tooltip" data-bs-title="View More" class="fa fa-arrows"></i>
                        </asp:LinkButton>
                    </p>
                </div>
                <div class="w3-quarter displayborder sContainers" style="width:25%;">
                    ...
                    <p>
                        ...
                        <asp:LinkButton ID="LinkButton5" runat="server" PostBackUrl="~/Order/cart.aspx" CssClass="mrg btn btn-2 btn-sep icon-cart" OnClick="btnAddToCart_Click">
          <i data-bs-toggle="tooltip" data-bs-title="Add to Cart" class="fa fa-shopping-cart"></i>
                        </asp:LinkButton>
                        <asp:LinkButton ID="LinkButton6" runat="server" PostBackUrl="~/Order/checkout.aspx" CssClass="mrg btn btn-2 btn-sep icon-cart" OnClick="btnBuyNow_Click">
          <i data-bs-toggle="tooltip" data-bs-title="Buy Now" class="fa fa-shopping-bag"></i>
                        </asp:LinkButton>
                        <asp:LinkButton ID="LinkButton7" runat="server" PostBackUrl="~/Product/IndividualProduct.aspx" CssClass="mrg btn btn-2 btn-sep icon-cart" OnClick="btnViewMore_Click">
          <i data-bs-toggle="tooltip" data-bs-title="View More" class="fa fa-arrows"></i>
                        </asp:LinkButton>
                    </p>
                </div>
                <div class="w3-quarter displayborder sContainers" style="width:25%;">
                    ...
                    <p>
                        ...
                        <asp:LinkButton ID="LinkButton8" runat="server" PostBackUrl="~/Order/cart.aspx" CssClass="mrg btn btn-2 btn-sep icon-cart" OnClick="btnAddToCart_Click">
          <i data-bs-toggle="tooltip" data-bs-title="Add to Cart" class="fa fa-shopping-cart"></i>
                        </asp:LinkButton>
                        <asp:LinkButton ID="LinkButton9" runat="server" PostBackUrl="~/Order/checkout.aspx" CssClass="mrg btn btn-2 btn-sep icon-cart" OnClick="btnBuyNow_Click">
          <i data-bs-toggle="tooltip" data-bs-title="Buy Now" class="fa fa-shopping-bag"></i>
                        </asp:LinkButton>
                        <asp:LinkButton ID="LinkButton10" runat="server" PostBackUrl="~/Product/IndividualProduct.aspx" CssClass="mrg btn btn-2 btn-sep icon-cart" OnClick="btnViewMore_Click">
          <i data-bs-toggle="tooltip" data-bs-title="View More" class="fa fa-arrows"></i>
                        </asp:LinkButton>
                    </p>
                </div>
