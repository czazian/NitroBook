...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-10">
            ...
            <h1 style="padding-left: 15px; font-size: 50px;"><strong>Fiction New Arrivals</strong></h1>
            <p style="float: right; margin-right: 20px; margin-top: 10px; width: 120px;">Showing 1 - 6</p>
