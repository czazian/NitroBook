    ...
    <div class="home-content">
        <div class="sales-boxes">
            ...
            <div class="recent-sales box">
                ...
                <asp:TextBox runat="server" ID="txtName" CssClass="input-field" Text="Suzume"></asp:TextBox>
                <br>
                ...
                <asp:TextBox runat="server" ID="txtPrice" CssClass="input-field" Text="300"></asp:TextBox>
                <br>
                    <label class="label-field">Description: </label>
                </br>
                <asp:TextBox runat="server" ID="txtDesc" CssClass="input-field" Text="Nice Book haha~"></asp:TextBox>
                <br>
