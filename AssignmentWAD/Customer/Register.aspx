...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="msform">
        ...
        <div class="auto-style1">
            ...
            <asp:TextBox ID="txtNewUsername" runat="server" placeholder="Username" CssClass="input" Width="300px"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Username is Required" ControlToValidate="txtNewUsername" ForeColor="#FF3300">*</asp:RequiredFieldValidator><asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="Username already exsits. Please choose another username." ControlToValidate="txtNewUsername" ForeColor="#FF3300" OnServerValidate="CustomValidator1_ServerValidate">*</asp:CustomValidator>
            ...
            <asp:TextBox ID="txtName" runat="server" placeholder="Name" CssClass="input" Width="300px"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Name is Required" ControlToValidate="txtName" ForeColor="#FF3300">*</asp:RequiredFieldValidator>
            &nbsp;
