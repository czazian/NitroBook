...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="msform">
        ...
        <div class="auto-style1">
            ...
            <asp:TextBox ID="txtUserID" runat="server" placeholder="UserID" CssClass="input" Width="300px" Enabled="False"></asp:TextBox>
            &nbsp;&nbsp;
            ...
            <asp:TextBox ID="txtName" runat="server" placeholder="Username" CssClass="input" Width="300px"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Name is Required" ControlToValidate="txtName" ForeColor="#FF3300">*</asp:RequiredFieldValidator>
            &nbsp;
            ...
            <asp:LinkButton ID="lbtSubmit" runat="server" CssClass="action-button" Style="font-family: 'HelveticaNeue','Arial', sans-serif;" Text="Submit"/>
            <br />
            <br />
