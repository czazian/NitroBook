...
<%--                     <div class="pw-view"><i class="fa fa-eye"></i></div> --%>
                    <br />
                    <p>
                         <asp:HyperLink runat="server" ID="hrefForgotPass"  NavigateUrl="~/Customer/ForgotPassword.aspx" CssClass="hlk" Text="Forgot password?"/><br />
                ...
                <div class="form-item">
                    <br />
                    <p class="pull-left">
    <asp:HyperLink runat="server" ID="hrefRegister" NavigateUrl="~/Customer/Register.aspx" CssClass="hlk" Text="Register"/>
</p>
